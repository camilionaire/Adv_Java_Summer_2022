...
public class TextDumperTest {
  ...
  @Test
  void test01AppointmentBookOwnerIsDumpedInTextFormat() {
  ...
  @Test
  void test02CanParseTextWrittenByTextDumper(@TempDir File tempDir) throws IOException, ParserException {
    String customer = "Test Phone Bill";
    PhoneBill bill = new PhoneBill(customer);
  ...
  @Test
  void test03CanParseTextWithPhoneNumbersByTextDumper(@TempDir File tempDir) throws IOException, ParserException, ParseException {
    String customer = "Test Phone Bill";
    PhoneBill bill = new PhoneBill(customer);
